                ...
                {currentOrders.map((order) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-3 pb-3 border-b border-slate-200 dark:border-slate-700">
                      <div>
                        <p className="text-xs text-slate-500 dark:text-slate-400">رقم الطلب</p>
                    ...
                    {/* Amount */}
                    <div className="mb-3">
                      <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">المبلغ الإجمالي</p>
                    ...
                    <div className="flex gap-2 pt-3 border-t border-slate-200 dark:border-slate-700">
                      <button
                        onClick={() => setSelectedOrder(order)}
                        className="flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-[#137fec] text-white hover:bg-[#137fec]/90 transition-colors text-sm font-medium"
                      >
