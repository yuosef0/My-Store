      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Desktop Table */}
            <div className="hidden md:block admin-table-container bg-white dark:bg-[#182635]">
              {loading ? (
              ...
              {loading ? (
                ...
                <div className="space-y-3">
                  {categories.map((category, index) => (
                    <div
                      key={category.id}
                      className="bg-white dark:bg-[#182635] rounded-lg border border-slate-200 dark:border-slate-800 p-4"
                    >
                      ...
                      <div className="flex gap-2 pt-3 border-t border-slate-200 dark:border-slate-800">
                        ...
                        <button
                          ...
                          className="flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-red-100 dark:bg-red-900/50 text-red-500 hover:bg-red-200 dark:hover:bg-red-900/70 transition-colors text-sm font-medium"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
