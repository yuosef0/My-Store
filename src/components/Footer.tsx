  ...
  return (
    <footer className="bg-[#f5f5f5] dark:bg-[#281313] mt-16 py-10">
      <div className="container mx-auto px-4 md:px-8 lg:px-16 grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-right">
        {/* About Section */}
        <div>
          <h3 className="text-xl font-bold mb-4 text-[#333333] dark:text-[#f0f0f0]">
          ...
          <div className="space-y-2 text-sm">
            ...
            {settings?.whatsapp_number && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#666666] dark:text-[#aaaaaa] hover:text-[#25d366] transition-colors flex items-center justify-center md:justify-start gap-2"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="text-center text-[#666666] dark:text-[#aaaaaa] mt-8 pt-6 border-t border-[#e5e7eb] dark:border-[#4a4a4a]">
        <p>{settings?.copyright_text || "© 2024 متجري. جميع الحقوق محفوظة."}</p>
      </div>
    </footer>
  );
}
